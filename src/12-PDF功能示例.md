...
| 主机名 | IP 地址 | 角色 | CPU | 内存 |
|:-------|:--------|:-----|:----|:-----|
| app-01 | 10.0.1.11 | 应用服务器 | 8核 | 16GB |
| app-02 | 10.0.1.12 | 应用服务器 | 8核 | 16GB |
| db-master | 10.0.2.21 | 数据库主节点 | 16核 | 64GB |
| db-slave | 10.0.2.22 | 数据库从节点 | 16核 | 64GB |
| redis-01 | 10.0.3.31 | 缓存节点 | 4核 | 32GB |

### 告警阈值配置

| 指标 | 警告阈值 | 严重阈值 | 检查间隔 |
|:-----|:---------|:---------|:---------|
| CPU 使用率 | 大于 70% | 大于 90% | 1 分钟 |
| 内存使用率 | 大于 75% | 大于 90% | 1 分钟 |
| 磁盘使用率 | 大于 80% | 大于 95% | 5 分钟 |
| 响应时间 | 大于 500ms | 大于 2000ms | 30 秒 |
| 错误率 | 大于 1% | 大于 5% | 1 分钟 |
